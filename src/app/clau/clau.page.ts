...
@Component({
  selector: 'app-clau',
  templateUrl: './clau.page.html',
  styleUrls: ['./clau.page.scss'],
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonGrid, IonRow, IonCol, IonImg, IonButton, CommonModule, FormsModule]
})
export class ClauPage implements OnInit {

  public basePath = 'assets/clau/';
...
export const ClauInfo = {
  name: "Claudio Luiz",
  age: 17,
  photo: "/assets/clau.jpeg",
  path: "/clau"
};