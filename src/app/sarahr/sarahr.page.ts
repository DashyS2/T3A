...
@Component({
  selector: 'app-sarahr',
  templateUrl: './sarahr.page.html',
  styleUrls: ['./sarahr.page.scss'],
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonGrid, IonRow, IonCol, IonImg, IonButton, CommonModule, FormsModule]
})
export class SarahrPage implements OnInit {

  public basePath = 'assets/saR/';
...
export const SarahRInfo = {
  name: "Sarah Reguffe da Silva",
  age: 17,
  photo: "/assets/saR.jpg",
  path: "/sarahr"
};